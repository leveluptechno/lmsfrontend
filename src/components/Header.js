...
const Header = () => {
  ...
  return (
    <>
      <div className='w-full bg-gradient-to-r from-blue-500 to-teal-400 h-[130px] shadow-lg flex justify-between items-center p-5 relative'>
        ...
        <div className='flex md:hidden absolute top-[54px] right-5'>
          ...
          <div className={`bg-white text-black font-serif w-[300px] absolute rounded-bl-lg justify-start p-5 shadow-lg  right-[-20px] top-[77px] z-10 ${threeDotDropdownOpen ? 'flex flex-col' : 'hidden'}`}>
            ...
            <Link onClick={toggleServicesDropdownThreeDot} className='hover:bg-gray-200 p-2 rounded flex items-center '>Service <IoMdArrowDropdown /></Link>
            ...
            <Link to="/psychometrictest" className='hover:bg-gray-200 p-2 rounded'>Psychometric Test</Link>
            <Link to="/contactform" className='hover:bg-gray-200 p-2 rounded'>Contact Us</Link>
        ...
        <div className='hidden  md:flex justify-end lg:justify-around font-serif items-center gap-3 flex-wrap text-white relative text-[25px]'>
          ...
          <div className='relative group'>
            <div onClick={toggleServicesDropdown} className='hover:underline flex justify-center items-center cursor-pointer'>
              Services
              <IoMdArrowDropdown />
          ...
          <Link to="/psychometrictest" className='hover:underline'>Psychometric Test</Link>
