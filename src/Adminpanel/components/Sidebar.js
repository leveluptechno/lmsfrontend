    ...
    <div className="h-screen bg-gray-800 text-white w-64">
      ...
      <div className="flex flex-col p-4 space-y-4">
        ...
        <div className="flex flex-col">
          ...
          {courseDropdown && (
            <div className="flex flex-col ml-8">
              <Link to="/admin/addcourses" className="p-2 hover:bg-gray-700 rounded">
                Add Course
              </Link>
              <Link to="/admin/allcourse" className="p-2 hover:bg-gray-700 rounded">
                All Courses
              </Link>
            </div>
          )}
        ...
        <div className="flex flex-col">
          ...
          {userDropdown && (
            <div className="flex flex-col ml-8">
              <Link to="/admin/adduser" className="p-2 hover:bg-gray-700 rounded">
                Add User
              </Link>
              <Link to="/admin/alluser" className="p-2 hover:bg-gray-700 rounded">
                All Users
              </Link>
            </div>
          )}
